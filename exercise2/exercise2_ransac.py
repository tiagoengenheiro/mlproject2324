...
reg = RANSACRegressor(random_state=0,min_samples=best_n_samples,residual_threshold=best_th,loss='absolute_error')
reg.fit(X_train_init,y_train_init)
print("Number of inliers:",len(reg.inlier_mask_[reg.inlier_mask_==True]))
