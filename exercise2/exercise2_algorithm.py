...
th=15
X_train_1=X_train[:th]
y_train_1=y_train[:th]
X_train_2=X_train[th:n_examples]
y_train_2=y_train[th:n_examples]
...
fit_linear_models(X_train,y_train,X_train_1,y_train_1,X_train_2,y_train_2,final=True)
